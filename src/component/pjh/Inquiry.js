        ...
        <div className={`${Style.bgColor} mt-10 mb-10`} data-aos="fade-up" data-aos-duration="2000">
            <div className={`${Style.mContainer} mt-5 mb-5 container`}>
                <div className="text-center pt-5">
                    <h1 className={`${Style.styleTitle} personalColorBold`}>문의하기<ChatFill className="pb-2 ms-1"></ChatFill></h1>
                ...
                <form className="row align-item-center p-5 text-center d-flex justify-center w-600" style={{ color: "rgb(66, 66, 66)" }}>
                    ...
                    <div className={`${Style.styleDiv} col-12 mb-3`}>
                        <p className={`${Style.styleContent} text-start`}>문의제목</p>
                        <input className={Style.columFrame} type='text'></input>
                    </div>
                    <div className={`${Style.styleDiv} col-12 mb-3`}>
                        <p className={`${Style.styleContent} text-start`}>이름</p>
                        <input className={Style.columFrame} type='text'></input>
                    </div>
                    <div className={`${Style.styleDiv} col-12 mb-3`}>
                        <p className={`${Style.styleContent} text-start`}>연락처</p>
                        <input className={Style.columFrame} type='text'></input>
                    </div>
                    <div className={`${Style.styleDiv} col-12 mb-3`}>
                     <p className={`${Style.styleContent} text-start`}>이메일주소</p>
                        <input className={Style.columFrame} type='text'></input>
                    </div>
                    <div className={`${Style.styleDiv} col-12 mb-3`}>
                        <p className={`${Style.styleContent} text-start`}>문의내용</p>
